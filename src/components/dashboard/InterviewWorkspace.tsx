...
export function InterviewWorkspace({ projectId }: { projectId: string }) {
  ...
  return (
    <div className="mx-auto grid max-w-4xl gap-6 lg:grid-cols-[1fr_320px]">
      <div className="flex flex-col rounded-3xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
        ...
        <div className="flex-1 overflow-y-auto py-6 space-y-4 max-h-[450px] min-h-[350px] pr-2">
          ...
          {submitting && (
            <div className="flex justify-start">
              <div className="flex items-center gap-2 max-w-[85%] rounded-2xl bg-zinc-50 p-4 text-sm text-zinc-500 dark:bg-zinc-800">
        ...
        {!isCompleted ? (
          ...
          <div className="border-t border-zinc-100 pt-6 dark:border-zinc-800 text-center">
            <div className="inline-flex size-12 items-center justify-center rounded-full bg-green-100 text-green-700 mb-3">
              <CheckCircle2 className="size-6" />
            </div>
            <h3 className="text-lg font-semibold text-zinc-900 dark:text-white">Interview Complete!</h3>
            <p className="mt-1 text-sm text-zinc-500">Your custom dashboard and business briefs are ready.</p>
            <button
              onClick={() => window.location.reload()}
              className="mt-4 inline-flex h-10 items-center justify-center gap-2 rounded-xl bg-green-700 px-6 text-sm font-semibold text-white hover:bg-green-800"
            >
      ...
      <aside className="space-y-5">
        <div className="rounded-3xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
          <h3 className="font-semibold text-zinc-900 dark:text-white">Onboarding Progress</h3>
          <p className="mt-1 text-xs text-zinc-500">We need a bit of details to start generating recommendations.</p>
          <div className="mt-5">
        ...
        {feedback && (
          <div className="rounded-3xl bg-[#eaf5ee] p-6 text-green-950">
            <h4 className="font-semibold text-sm">Copilot Feedback</h4>
