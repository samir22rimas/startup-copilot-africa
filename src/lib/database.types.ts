export type MemberRole = "owner" | "admin" | "member" | "advisor";
  ...
  public: {
    Tables: {
      ...
      startup_members: {
        ...
        Insert: Omit<
          Database["public"]["Tables"]["startup_members"]["Row"],
          "joined_at"
        > &
          Partial<
            Pick<
      ...
      projects: {
        ...
        Update: Partial<
          Omit<
            Database["public"]["Tables"]["projects"]["Row"],
            "id" | "startup_id" | "created_by" | "created_at"
          >
        >;
        Relationships: [];
      };
      ai_configurations: {
        ...
        Insert: Omit<
          Database["public"]["Tables"]["ai_configurations"]["Row"],
          | "id"
          | "created_at"
          | "updated_at"
          | "model"
        ...
        > &
          Partial<
            Pick<
              Database["public"]["Tables"]["ai_configurations"]["Row"],
              "id" | "model" | "system_instructions" | "settings"
            >
          >;
        Update: Partial<
          Omit<
      ...
      knowledge_documents: {
        ...
        Update: Partial<
          Omit<
            Database["public"]["Tables"]["knowledge_documents"]["Row"],
            "id" | "startup_id" | "uploaded_by" | "created_at"
          >
        >;
        Relationships: [];
      };
      conversations: {
        ...
        > &
          Partial<
            Pick<
              Database["public"]["Tables"]["conversations"]["Row"],
              "id" | "project_id" | "title" | "archived_at"
            >
          >;
        Update: Partial<
          Omit<
      ...
      messages: {
        ...
        > &
          Partial<
            Pick<
              Database["public"]["Tables"]["messages"]["Row"],
              "id" | "author_id" | "model" | "token_count" | "metadata"
            >
          >;
        Update: never;
        Relationships: [];
      ...
      insights: {
        ...
        Update: Partial<
          Omit<
            Database["public"]["Tables"]["insights"]["Row"],
            "id" | "startup_id" | "requested_by" | "kind" | "created_at"
          >
        >;
        Relationships: [];
      };
      usage_events: {
        ...
        Insert: Omit<
          ...
          "id" | "quantity" | "metadata" | "occurred_at"
        > &
          Partial<
            Pick<
              Database["public"]["Tables"]["usage_events"]["Row"],
              "quantity" | "metadata" | "occurred_at"
            >
          >;
        Update: never;
        Relationships: [];
