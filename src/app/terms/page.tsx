...
import { ArrowLeft, FileText, ShieldCheck, UserCheck, Scale, AlertCircle, HelpCircle } from "lucide-react"
import { ThemeToggle } from "@/src/components/shared/ThemeToggle"

export const metadata = {
  title: "Terms of Service | Startup Copilot Africa",
  description: "Terms of Service and Conditions of Use for Startup Copilot Africa.",
}
      ...
      <section className="bg-[#082b22] py-16 text-white border-b border-green-400/20">
        <div className="mx-auto max-w-4xl px-6">
          ...
          <p className="mt-3 text-base text-green-100/80">
            Please read these terms carefully before using Startup Copilot Africa.
          </p>
